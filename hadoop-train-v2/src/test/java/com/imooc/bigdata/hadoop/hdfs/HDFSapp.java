...
public class HDFSapp {
    ...
    public void setUp() throws Exception {
         ...
         */
        fileSystem = FileSystem.get(new URI(HDFS_PATH), configuration, "zhaohao");
    }
...
//        FSDataOutputStream out = fileSystem.create(new Path("/hdfsapi/test/a.txt"));
    ...
    public void copyFromLocalFile() throws Exception {
        Path src = new Path("/Users/zhaohao/Desktop/app/hadoop-2.6.0-cdh5.14.0/hello.txt");
    ...
    public void delete() throws Exception {
        boolean result = fileSystem.delete(new Path("/hdfsapi/test/hello.txt"), true);
        System.out.println(result);
    }
